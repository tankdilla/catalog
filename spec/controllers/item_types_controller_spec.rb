...
RSpec.describe ItemTypesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all item_types as @item_types" do
      ...
      expect(assigns(:item_types)).to eq([item_type])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested item_type as @item_type" do
      item_type = ItemType.create! valid_attributes
      get :show, {:id => item_type.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested item_type as @item_type" do
      item_type = ItemType.create! valid_attributes
      get :edit, {:id => item_type.to_param}, valid_session
      expect(assigns(:item_type)).to eq(item_type)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new ItemType" do
        expect {
          post :create, {:item_type => valid_attributes}, valid_session
        }.to change(ItemType, :count).by(1)
      end

      it "assigns a newly created item_type as @item_type" do
        post :create, {:item_type => valid_attributes}, valid_session
        expect(assigns(:item_type)).to be_a(ItemType)
        expect(assigns(:item_type)).to be_persisted
      end

      it "redirects to the created item_type" do
        post :create, {:item_type => valid_attributes}, valid_session
        expect(response).to redirect_to(ItemType.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved item_type as @item_type" do
        post :create, {:item_type => invalid_attributes}, valid_session
        expect(assigns(:item_type)).to be_a_new(ItemType)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested item_type" do
        item_type = ItemType.create! valid_attributes
        put :update, {:id => item_type.to_param, :item_type => new_attributes}, valid_session
        item_type.reload
      ...
      it "assigns the requested item_type as @item_type" do
        item_type = ItemType.create! valid_attributes
        put :update, {:id => item_type.to_param, :item_type => valid_attributes}, valid_session
        expect(assigns(:item_type)).to eq(item_type)
      end
    ...
    describe "with invalid params" do
      it "assigns the item_type as @item_type" do
        item_type = ItemType.create! valid_attributes
        put :update, {:id => item_type.to_param, :item_type => invalid_attributes}, valid_session
        expect(assigns(:item_type)).to eq(item_type)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested item_type" do
      item_type = ItemType.create! valid_attributes
      expect {
        delete :destroy, {:id => item_type.to_param}, valid_session
      }.to change(ItemType, :count).by(-1)
    end
